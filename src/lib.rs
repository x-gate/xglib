...
pub use types::{
    ...
    AnimeInfo, CGP_CUSTOM_COLOR_COUNT, CGP_SIZE, EMBEDDED_COLOR_STRIDE, GRAPHIC_HEADER_SIZE,
    GRAPHIC_INFO_SIZE, GRAPHIC_MAGIC, Palette, Graphic, GraphicHeader, GraphicInfo,
    MAP_HEADER_SIZE, MAP_MAGIC, Map, MapHeader, PALETTE_COLOR_COUNT, PALETTE_FIXED_PREFIX_COUNT,
    PALETTE_FIXED_SUFFIX_COUNT,
};
